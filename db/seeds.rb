...
Scope.create(user_id:1, scope: "Khurasan")
Scope.create(user_id:1, scope: "Syria") #5
Scope.create(user_id:1, scope: "Iraq")
Scope.create(user_id:1, scope: "Fars")
Scope.create(user_id:1, scope: "Homs")
Scope.create(user_id:1, scope: "Damascus")
Scope.create(user_id:1, scope: "Merv") #10

Relation.create(user_id: 1, position: "Father")
Relation.create(user_id: 1, position: "Mother")
Relation.create(user_id: 1, position: "Mawali")
Relation.create(user_id: 1, position: "Servant")
Relation.create(user_id: 1, position: "Slave")
Relation.create(user_id: 1, position: "Ally")
...
Classical_Muslim.create(user_id: 1, ism: "al_Abbas", laqab: nil, nisbah: nil, nasab: "ibn al-Walid ibn 'Abd al-Malik",  kunya: nil)
  Description.create(table: "classical_muslims", user_id: 1, classical_muslim_id: 1, content: "He was the head of Banu Marwan when his brother of Yazid III led his coup against al-Walid II. While al-Abbas at first tries to convince Yazid’s against rebellion, he joined Yazid’s supporters before al-Walid II was killed.")
...
Classical_Muslim.create(user_id: 1, ism: nil, laqab: nil, nisbah: "al-Sufyani", nasab: "ibn ‘Abdallah ibn Yazid ibn Mu’awiya",  kunya: "Abu Muhammad")
 Description.create(table: "classical_muslims", user_id: 1, classical_muslim_id: 2,  content: "The people of Homs rallied around him against Yazid III’s rule, but he was defeated and imprisoned. He survived the panic in Damascus as Marwan II approached, and in one account delivered the wish of al-Walid II’s heir that Marwan be Caliph if he should die. He participated later in a revolt in Syria against Abbasid rule.")
...
Classical_Muslim.create(user_id: 1, ism: "‘Abdallah", laqab: nil, nisbah: nil, nasab: "ibn ‘Umar ",  kunya: nil)
  Description.create(table: "classical_muslims", user_id: 1, classical_muslim_id: 3, content: "Yazid III’s second governor of Iraq, replacing Mansur b. Jumhur. He at first tried to keep Hashimite ‘Abdallah b. Mu’awiya as an ally when Marwan marched on Syria, but Ibn Mu’awiya gained support and rebelled in Kufa. He allowed the rebels to leave as he and his largely Yamani following had to face Marwan's appointed but Mudari-backed governor of Iraq.. He and his supporters joined the Khariji rebels to unite against Marwan, until they were defeated by the Caliph. He was captured, and according to reports about the death of the Abbasid Ibrahim al-Imam, taken to prison in Harran where he died around the same time as Ibrahim."
...
Classical_Muslim.create(ism: "‘Abd al-‘Aziz", laqab: nil, nisbah: nil, nasab: "ibn al-Hajjaj",  kunya: nil)
  Description.create(table: "classical_muslims", uer_id:1, classical_muslim_id: 4, content: "Supported Yazid III’s coup and led Yazid’s army to victory against al-Walid II. When Homs did not give the oath to Ibrahim he sieged it, only to be defeated by Marwan on the latter’s way to Damascus. During the fall of Damascus, ‘Abd al-‘Aziz was killed by a mawla of al-Walid II."
...
Classical_Muslim.create(user_id: 1, ism: "‘Abd ar-Rahman", laqab: nil, nisbah: nil, nasab: "ibn Mu’awiya ibn Hisham",  kunya: nil)
...
Classical_Muslim.create(user_id: 1, ism: "al-Abrash", laqab: nil, nisbah: nil, nasab: "ibn al-Walid",  kunya: nil)
   Description.create(table: "classical_muslims", user_id: 1, classical_muslim_id: 6, content: "Along with Sulayman b. Hisham, he asked Marwan to seek a peaceful resolution to the revolt of Banu Kalb at Thadmur. He convinced the Kalb to submit to Marwan, though some fled into the desert."
...
Classical_Muslim.create(user_id: 1, ism: "Bishr", laqab: nil, nisbah: nil, nasab: "ibn al-Walid",  kunya: nil)
  Description.create(table: "classical_muslims", user_id: 1, classical_muslim_id: 7, content: "The Qaysis in his army under Ibn Hubayrah defected to Marwan when he attempted to block Marwan’s route to his brother, Ibrahim, in Damascus."
...
Classical_Muslim.create(user_id: 1, ism: "Ibrahim", laqab: nil, nisbah: nil, nasab: "ibn al-Walid",  kunya: nil)
  Description.create(table: "classical_muslims", user_id: 1, classical_muslim_id: 8, content: "He was named successor to the Caliphate by his brother Yazid III, however, his rule was not widely recognized. He soon was effectively deposed by Marwan II. At first he fled the armies of Marwan, but was later granted amnesty and stayed loyal until his death in the Battle of the Zab against the Abbasid."
    ...
    Position.create(user_id: 1, classical_muslim_id: 8, title_id: 1, scope_id: 1, start_date: "744", end_date: "744") #UMAYYAD CALIPH
    Adherent.create(user_id: 1, classical_muslim_id: 8, faction_id: 1) 
    Adherent.create(user_id: 1, classical_muslim_id: 8, faction_id: 2) 


Classical_Muslim.create(user_id: 1, ism: "Hisham", laqab: nil, nisbah: nil, nasab: "ibn ‘Abd al-Malik",  kunya: nil)
...
Classical_Muslim.create(user_id: 1, ism: "Masrur", laqab: nil, nisbah: nil, nasab: "ibn al-Walid ibn 'Abd al-Malik",  kunya: nil)
  Description.create(table: "classical_muslims", user_id: 1, classical_muslim_id: 11, content: "He lead the army on Homs for his brother Yazid III, but was captured with Bishr b. al-Walid when the Qaysi element under Ibn Hubayrah defeated to ......."
...
Classical_Muslim.create(user_id: 1, ism: "Sa’id", laqab: nil, nisbah: nil, nasab: "ibn Hisham ibn ‘Abd al-Malik",  kunya: nil)
  Description.create(table: "classical_muslims", user_id: 1, classical_muslim_id: 12, content: "Commanded Homs for his brother, Sulayman, when the latter fled the advance of Marwan’s army. People inside Homs eventually betray him to Marwan in exchange for their safety, and Sa’id was taken to prisoner with his sons to Harran. There he joined Ibrahim al-Imam and ‘Abdallah b. ‘Umar. Reports are numerous, but one claims he escaped from prison only to be killed by the people of Harran."
...
Classical_Muslim.create(user_id: 1, ism: "Sulayman", laqab: nil, nisbah: nil, nasab: "ibn Hisham ibn ‘Abd al-Malik",  kunya: nil)
  Description.create(table: "classical_muslims", user_id: 1,  classical_muslim_id: 13, content: "He was lashed by al-Walid II before being imprisoned. He was freed and joined Yazid III’s army after the latter took Damascus. While he fled when Marwan came to depose Ibrahim, he later received safety from the new Caliph and stayed with Marwan’s force. Later he broke his word and revolted. Reports differ, but he either returned to Homs or fled to join the Khawarij. From there he joined the Hashemite ‘Abdallah b. Mu’awiya, until the latter’s defeat. Eventually, he fled to Sind."
...
Classical_Muslim.create(user_id: 1, ism: "Yazid", laqab: nil, nisbah: nil, nasab: "ibn al-Walid",  kunya: nil)
...
Classical_Muslim.create(user_id: 1, ism: "al-Walid", laqab: nil, nisbah: nil, nasab: "ibn Mu’awiya ibn Marwan",  kunya: nil)
  Description.create(table: "classical_muslims", user_id: 1, classical_muslim_id: 15, content: "He was chosen by the people of Jordan after Marwan took Damascus."
